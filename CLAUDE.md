...
- **Multi-currency payments**: `currency` column on schools, invoices, and payments. Gateways behind a common interface: Stripe (global) + bKash & SSLCommerz (BD). Gateway choice per school.
