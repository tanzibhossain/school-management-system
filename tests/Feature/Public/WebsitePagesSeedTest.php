...
class WebsitePagesSeedTest extends TestCase
{
    ...
    {
        foreach (['history', 'about', 'mission', 'administration', 'staff', 'teachers', 'online-admission', 'gallery', 'video', 'contact', 'notices'] as $slug) {
    ...
    {
        // Staff page shows a seeded teacher.
        $this->get('/staff')->assertOk()->assertSee('Abdul Karim');
