...
<?= $open ?>
  ...
  <?php if (session('admission_reference')): ?>
    <div class="alert alert-success"><i class="bi bi-check-circle"></i> Application submitted. Your reference number is <strong><?= e(session('admission_reference')) ?></strong> — please keep it safe.</div>
  <?php endif; ?>
  <?php if ($errors->any()): ?>
  ...
  <form method="POST" action="<?= route('admission.submit') ?>" enctype="multipart/form-data" class="card"><div class="card-body">
    <?= csrf_field() ?>
    {{-- Student --}}
    <h3 class="text-uppercase text-muted small fw-semibold">Student information</h3>
    <div class="row g-3 mb-3">
      ...
      <?php endif; ?>
      <div class="col-md-4"><label class="form-label">Date of birth <span class="text-danger">*</span></label>
        <input type="date" name="dob" class="form-control" value="<?= e(old('dob')) ?>" required>
        <div class="form-text">Must fall within the age range set for the selected class.</div></div>
      <div class="col-md-4"><label class="form-label">Birth certificate no. <span class="text-danger">*</span></label>
      ...
      <div class="col-md-4"><label class="form-label">Religion <span class="text-danger">*</span></label>
      ...
      <?php endif; ?>
      <div class="col-md-4"><label class="form-label">Class applying for <span class="text-danger">*</span></label>
      ...
      <div class="col-md-4"><label class="form-label">Academic year <span class="text-danger">*</span></label>
      ...
      <div class="col-md-4"><label class="form-label">GPA <span class="text-danger">*</span></label>
        <input name="gpa" class="form-control" value="<?= e(old('gpa')) ?>" required></div>
      <div class="col-md-8"><label class="form-label">Previous school <span class="text-danger">*</span></label>
    ...
    {{-- Parents --}}
    <h3 class="text-uppercase text-muted small fw-semibold">Parent information</h3>
    <div class="row g-3 mb-3">
    ...
    <h3 class="text-uppercase text-muted small fw-semibold">Guardian information</h3>
    <div class="row g-3 mb-3">
      <div class="col-md-3"><label class="form-label">Guardian type <span class="text-danger">*</span></label>
      ...
      <div class="col-md-3"><label class="form-label">Guardian name</label>
        <input name="guardian_name" class="form-control" value="<?= e(old('guardian_name')) ?>" placeholder="If other than parent"></div>
      <div class="col-md-3"><label class="form-label">Guardian phone</label>
    ...
    {{-- Address --}}
    <h3 class="text-uppercase text-muted small fw-semibold">Address</h3>
    <div class="row g-3 mb-3">
      <div class="col-12"><label class="form-label">Present address <span class="text-danger">*</span></label>
      ...
      <div class="col-12">
        <div class="form-check mb-1"><input type="hidden" name="is_permanent_same" value="0"><input class="form-check-input" type="checkbox" name="is_permanent_same" value="1" id="permsame" <?php if (old('is_permanent_same')) echo 'checked'; ?>>
          <label class="form-check-label" for="permsame">Permanent address same as present</label></div>
    ...
    <h3 class="text-uppercase text-muted small fw-semibold">Additional information</h3>
    <div class="row g-3 mb-3">
    ...
    <button class="btn btn-brand"><i class="bi bi-send"></i> Submit application</button>
  </div></form>
<?= $close ?>