...
<div class="row g-4">
    {{-- Personal Settings --}}
    <div class="col-xl-6">
        <x-card title="{{ __('Personal Information') }}" subtitle="Student details">
    ...
    {{-- Contact Settings --}}
    <div class="col-xl-6">
        <x-card title="{{ __('Contact Information') }}" subtitle="Phone, email, and address">
            <form action="{{ route('admin.students.update', $student) }}" method="POST" class="form-layout">
                @csrf @method('PUT')
                <div class="row g-3">
                    <div class="col-md-6">
...
<div class="row g-4 mt-4">
    {{-- Guardian Settings --}}
    <div class="col-xl-6">
        <x-card title="{{ __('Guardian Information') }}" subtitle="Primary guardian contact">
            @if($guardian = $student->guardians->first())
                <form action="{{ route('admin.students.guardian.update', $student) }}" method="POST" class="form-layout">
                    ...
                    <div class="mt-3">
                        <x-button variant="primary">{{ __('Save Guardian Info') }}</x-button>
                    </div>
                </form>
            @else
    ...
    <div class="col-xl-6">
        <x-card title="Account & Security" subtitle="User account management">
            <dl class="row mb-4">
                <dt class="col-sm-4 text-muted small">{{ __('Username') }}</dt>
                ...
                <dt class="col-sm-4 text-muted small">{{ __('Roles') }}</dt>
                <dd class="col-sm-8">
                ...
                <dt class="col-sm-4 text-muted small">{{ __('Last Login') }}</dt>
    ...
    <div class="col-xl-6">
        <x-card title="{{ __('Notification Preferences') }}" subtitle="Choose how you want to be notified">
            <form action="{{ route('admin.students.notifications.update', $student) }}" method="POST" class="form-layout">
                @csrf @method('PUT')
                <div class="row g-3">
                    <div class="col-12">
                        <fieldset>
                            <legend class="form-label fw-medium mb-2">{{ __('SMS Notifications') }}</legend>
                            <div class="row g-3">
                                <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <fieldset>
                            <legend class="form-label fw-medium mb-2">{{ __('Email Notifications') }}</legend>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                    ...
                    <div class="col-12">
                        <fieldset>
                            <legend class="form-label fw-medium mb-2">{{ __('Push Notifications (App)') }}</legend>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                    ...
                    <div class="col-12 mt-4">
                        <x-button variant="primary" type="submit">{{ __('Save Preferences') }}</x-button>
                    </div>
                </div>
            </form>
        </x-card>
