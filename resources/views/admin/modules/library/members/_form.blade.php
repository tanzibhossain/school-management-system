...
<div class="modal fade" id="{{ $modalId }}" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
  <form method="POST" action="{{ $action }}">
    ...
    <div class="modal-body row g-3">
      <div class="col-12"><label class="form-label">User account <span class="text-danger">*</span></label>
      ...
      <div class="col-md-7"><label class="form-label">Membership number <span class="text-danger">*</span></label>
      ...
      <div class="col-md-5"><label class="form-label">Type <span class="text-danger">*</span></label>
        <select name="member_type" class="form-select" required>
          <option value="student" @selected(($isEdit ? $m->member_type : old('member_type'))==='student')>Student</option>
          <option value="staff" @selected(($isEdit ? $m->member_type : old('member_type'))==='staff')>Staff</option>
        </select></div>
      <div class="col-md-6"><label class="form-label">Joined</label>
