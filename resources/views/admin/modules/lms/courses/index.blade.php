...
@section('content')
  ...
  <div class="card"><div class="card-body">
    <table class="table table-hover align-middle w-100 js-dt">
      <thead><tr><th>Title</th><th>Class</th><th>Subject</th><th>Teacher</th><th>Lessons</th><th>Assignments</th><th class="text-end" data-orderable="false">Actions</th></tr></thead>
      <tbody>
        @foreach ($courses as $c)
          <tr>
            ...
            <td class="text-end"><a class="btn btn-sm btn-outline-primary" href="{{ route('admin.lms.courses.show', $c->id) }}">Open</a></td>
          </tr>
        @endforeach
      </tbody>
    </table>
  ...
  <div class="modal fade" id="createModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <form method="POST" action="{{ route('admin.lms.courses.store') }}">
      ...
      <div class="modal-body row g-3">
        ...
        <div class="col-md-6"><label class="form-label">Subject <span class="text-danger">*</span></label>
