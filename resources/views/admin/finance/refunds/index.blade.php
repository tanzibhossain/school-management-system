...
@section('content')
  ...
  <div class="card"><div class="card-body">
    <table class="table table-hover align-middle w-100 js-dt">
      <thead><tr><th>Payment</th><th>Method</th><th class="text-end">Amount</th><th class="text-end">Fee</th><th class="text-end">Net</th><th>Status</th></tr></thead>
      <tbody>
  ...
  <div class="modal fade" id="requestModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <form method="POST" action="{{ route('admin.refunds.store') }}" id="refundForm">
      ...
      <div class="modal-body row g-3">
        <div class="col-12"><label class="form-label">Payment <span class="text-danger">*</span></label>
      ...
      <div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button><button class="btn btn-primary">Request</button></div>
    </form>
  </div></div></div>
