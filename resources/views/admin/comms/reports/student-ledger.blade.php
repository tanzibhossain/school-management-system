...
@section('title', 'Student ledger report')
@section('content')
  ...
  <ul class="nav nav-pills mb-3">
    ...
    <li class="nav-item"><a class="nav-link active" href="{{ route('admin.reports.student-ledger') }}">Student ledger</a></li>
  </ul>

  <form method="GET" class="card mb-3"><div class="card-body row g-2 align-items-end">
    <div class="col-sm-5"><label class="form-label small text-muted mb-1">Student</label>
  ...
  @if ($data && $student)
    <div class="d-flex justify-content-between align-items-center mb-2">
      ...
      <a class="btn btn-sm btn-outline-danger" href="{{ route('admin.reports.student-ledger', array_filter(['student_id' => $student->id, 'date_from' => $filters['date_from'] ?? null, 'date_to' => $filters['date_to'] ?? null, 'format' => 'pdf'])) }}" target="_blank"><i class="bi bi-file-pdf"></i> PDF</a>
    </div>
  ...
  @else
    <div class="alert alert-info">Select a student to view their ledger.</div>
  @endif
@endsection
