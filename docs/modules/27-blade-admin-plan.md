...
| 6 | **Optional modules** | Module-gated sidebar + routes (`module.enabled:*`). **Library** ✅ (`LibraryModuleTest.php`), **Transport** ✅ (`TransportModuleTest.php`), **Payroll** ✅ (components, staff salaries, runs process/approve · `PayrollModuleTest.php`). LMS ⬜ | 🟡 in progress |
