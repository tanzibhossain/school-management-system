...
| 6 | **Optional modules** | Module-gated sidebar + routes (`module.enabled:*`). **Library** ✅ (`LibraryModuleTest.php`), **Transport** ✅ (drivers/vehicles/routes + vehicle & rider assignment · `TransportModuleTest.php`). Payroll / LMS ⬜ | 🟡 in progress |
